...
$sql = " SELECT FirstName,Email,CandidateId FROM Candidates Inner Join CandidateLikes on Candidates.Id=CandidateLikes.CandidateId ";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Liked Candidates</p>
                  <div class="row">
                    <div class="col-12">
